...
#Переходим в корзину и удаляем товар
    ...
    for rd in ft:
        ...
        rd_1 = str(int(rd) + 1)
        WebDriverWait(start, 10).until(EC.invisibility_of_element_located((By.XPATH, '//*[@id="order_confirmation-wrapper"]/table/tbody/tr[' + rd_1 + ']/td[3]')))#Дожидаемся пока обновится таблица внизу
